...
import static ajn.kpu.kuispengetahuanumum.R.layout.quiz_main;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private Button mButtonChoice5; //jawaban 4
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber < mQuestionLibrary.getLength() ){
            ...
            Toast.makeText(QuizActivity.this, "Itu tadi pertanyaan terakhir!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(QuizActivity.this, HighScore.class);
            intent.putExtra("Skor", mScore); // pass the current score to the second screen
